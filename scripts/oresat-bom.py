...
"""
    ...
    Sorted By: Ref
    Fields: Qty, P/DNP, Parts, MFR, MPN, Description, Generic, Assembly, Stock, Dist, DPN, Value, Name, Footprint

    Command line:
    python "pathToFile/oresat-bom.py" "%I" "%O.csv"
"""
...
out.writerow(['Qty', 'P/DNP', 'Parts', 'MFR', 'MPN', 'Description', 'Generic', 'Assembly', 'Stock', 'Dist', 'DPN', 'Value', 'Name', 'Footprint'])
...
for group in grouped:
    ...
    out.writerow([
        len(group),
        fromNetlistText( c.getField("P/DNP") ),
        refs, 
        fromNetlistText( c.getField("MFR") ),
        fromNetlistText( c.getField("MPN") ),
        fromNetlistText( c.getDescription() ),
        fromNetlistText( c.getField("Generic") ),
        fromNetlistText( c.getField("Assembly") ),
        fromNetlistText( c.getField("Stock") ),
        fromNetlistText( c.getField("Dist") ),
        fromNetlistText( c.getField("DPN") ),
